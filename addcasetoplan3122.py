...
testplan_name = "ACP3.12.2发版测试-第一轮手动测试"
parent_suite = "容器平台"
...
suite_assign = [
    ...
    {"suitename": "平台管理-网络管理>负载均衡器-v2", "user": "kewang", "case_importance": ("3")},
    ...
    # {"suitename": "业务视图-计算组件>部署", "user": "zxzhang", "case_importance": ("3")},
    # {"suitename": "业务视图-计算组件>守护进程集", "user": "zxzhang", "case_importance": ("3")},
    # {"suitename": "业务视图-计算组件>有状态副本集", "user": "zxzhang", "case_importance": ("3")},
    # {"suitename": "业务视图-计算组件>定时任务", "user": "xfzhao", "case_importance": ("3")},
    # {"suitename": "业务视图-计算组件>任务", "user": "xfzhao", "case_importance": ("3")},
    # {"suitename": "业务视图-计算组件>容器组", "user": "zxzhang", "case_importance": ("3")},
    # {"suitename": "业务视图-计算组件>弹性伸缩", "user": "zxzhang", "case_importance": ("3")},
    # {"suitename": "业务视图-计算组件>通用-镜像选择组件", "user": "zxzhang", "case_importance": ("3")},
    {"suitename": "业务视图-计算组件>通用-容器组表单", "user": "zxzhang", "case_importance": ("3")},
    # {"suitename": "业务视图-计算组件>通用-详情页组件", "user": "zxzhang", "case_importance": ("3")},
    {"suitename": "业务视图-计算组件>通用-容器组列表", "user": "zxzhang", "case_importance": ("3")},
    # {"suitename": "业务视图-计算组件>通用-局部更新", "user": "zxzhang", "case_importance": ("3")},
    # {"suitename": "业务视图-计算组件>通用-取消-阻断性提示", "user": "zxzhang", "case_importance": ("3")},
    # {"suitename": "业务视图-配置", "user": "zxzhang", "case_importance": ("3")},
    ...
    # {"suitename": "平台管理-超售比", "user": "zxzhang", "case_importance": ("3")},
    # {"suitename": "项目管理-命名空间", "user": "zxzhang", "case_importance": ("3")},
    # # 标准功能
    ...
    # {"suitename": "业务视图-计算组件>通用-debug", "user": "zxzhang", "case_importance": ("3")},
    # {"suitename": "业务视图-计算组件>gpu", "user": "zxzhang", "case_importance": ("3")},
    ...
    # {"suitename": "平台管理-集群管理-自定义资源", "user": "zxzhang", "case_importance": ("3")},
