...
jql = 'project = ACP AND summary ~ 功能测试执行 AND summary !~ 非功能  AND summary !~ S1 AND summary !~ S2 AND summary !~ S3 AND issuetype in (Job, Task) AND resolution in (Done, "Pass Test") AND resolved >= -1d'
