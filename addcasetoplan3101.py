...
testplan_name = "ACP3.10.2发版测试-第一轮手动测试"
parent_suite = "容器平台"
...
suite_assign = [
    ...
    {"suitename": "平台管理-存储管理>存储相关方案case", "user": "myliu", "case_importance":  ("3")},
    ...
    {"suitename": "平台管理-安全管理>节点隔离策略", "user": "jnshi", "case_importance":  ("3")},
    {"suitename": "业务视图-网络>alb集成GatewayAPI", "user": "kewang", "case_importance":  ("3")},
    {"suitename": "项目管理-命名空间>命名空间概览", "user": "hlzheng", "case_importance":  ("3")},
    {"suitename": "平台管理-集群管理-自定义资源", "user": "myliu", "case_importance":  ("3")},
